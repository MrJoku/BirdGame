...
int main(int argc, char *argv[])
{
	...
	SDL_Texture *texture = IMG_LoadTexture(renderer, "sprites/bird.png");
	SDL_Texture *pipeTexture = IMG_LoadTexture( renderer, "sprites/pipe.png");
	SDL_Texture *grassTexture = IMG_LoadTexture( renderer, "sprites/grass.png");
	// SCORE TEXT
	TTF_Font* font;
	...
	while (!close)
	{
		...
		// GRASS TEXTURE
		SDL_RenderCopyEx(renderer, grassTexture, NULL, &rect2, 0, NULL, SDL_FLIP_NONE);

		// BIRD RECT
		SDL_RenderCopyEx(renderer, texture, NULL, &rect1, 8 + rect1.y, NULL, SDL_FLIP_NONE);

		// PIPE TEXTURE
		SDL_RenderCopyEx(renderer, pipeTexture, NULL, &pipe1, 180, NULL, SDL_FLIP_NONE);
		SDL_RenderCopyEx(renderer, pipeTexture, NULL, &pipe2, 0, NULL, SDL_FLIP_NONE);
